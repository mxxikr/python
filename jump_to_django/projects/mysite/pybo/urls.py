...
# 모듈명 표시되도록 변경 -> 어떤 파일의 어떤 함수인지 명확하게 인지 가능
urlpatterns = [
    # base_views.py
    path('', 
    ...
    path('question/delete/<int:question_id>/', 
        question_views.quesiton_delete, name='question_delete'),
    ...
    path('vote/question/<int:question_id>/',
        vote_views.voter_question, name='voter_question'),
    path('vote/answer/<int:answer_id>/',
        vote_views.voter_answer, name='voter_answer'),
]
